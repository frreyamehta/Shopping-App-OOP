...
public class AddEthnic extends JPanel {
    ...
    //Constructor
    public AddEthnic(Connection connection) {
        //Setting the layout
    ...
    private void addStock(Connection connection) {
        ...
        if (validInp) {
            String query = "INSERT INTO Ethnic(ItemNo,ItemName,Price,Store,Gender,Colour,Type,Size) VALUES(?,?,?,?,?,?,?,?)";
            try {
