...
public class AddHoodies extends JPanel {
    ...
    //Constructor
    public AddHoodies(Connection connection) {
        //Setting the layout
    ...
    private void addStock(Connection connection) {
        ...
        if (validInp) {
            String query = "INSERT INTO Hoodies(ItemNo,ItemName,Price,Store,Gender,Colour,Type,Size) VALUES(?,?,?,?,?,?,?,?)";
            try {
