...
public class AddDresses extends JPanel {
    ...
    //Constructor
    public AddDresses(Connection connection) {
        //Setting the layout
    ...
    private void addStock(Connection connection) {
        ...
        if (validInp) {
            String query = "INSERT INTO Dresses(ItemNo,ItemName,Price,Store,Colour,Size) VALUES(?,?,?,?,?,?)";
            try {
                ...
                e.printStackTrace();
                JOptionPane.showMessageDialog(this, "Error Adding to stock"+e.getMessage());
            }
        }
    }
}
