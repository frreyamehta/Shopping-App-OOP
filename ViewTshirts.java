...
public class ViewTshirts extends JFrame {
    //Defining all components
    private JPanel ViewPanel;
    private JTable table1;

    //Constructor
    public ViewTshirts(Connection connection) {
        setLayout(new BorderLayout());
        viewShirt(connection);
        setContentPane(ViewPanel);
        setTitle("View Tshirts");
        setSize(800, 400);
    ...
    private void viewShirt(Connection connection) {
        ...
        try {
            ...
            while (result.next()) {
                ...
                model.addRow(new Object[]{id, name, price, store, gender, colour, size});
            }
