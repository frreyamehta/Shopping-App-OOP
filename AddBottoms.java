...
public class AddBottoms extends JPanel {
    ...
    //Constructor
    public AddBottoms(Connection connection) {
        //Setting the layout
    ...
    private void addStock(Connection connection) {
        ...
        if (validInp) {
            String query = "INSERT INTO Bottoms(ItemNo,ItemName,Price,Store,Gender,Colour,Type,Size) VALUES(?,?,?,?,?,?,?,?)";
            try {
