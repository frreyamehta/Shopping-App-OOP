...
public class AddShirts extends JPanel {
    ...
    //Constructor
    public AddShirts(Connection connection) {
        //Setting the layout
    ...
    private void addStock(Connection connection) {
        ...
        if (validInp) {
            String query = "INSERT INTO Shirts(ItemNo,ItemName,Price,Store,Colour,Size) VALUES(?,?,?,?,?,?)";
            try {
